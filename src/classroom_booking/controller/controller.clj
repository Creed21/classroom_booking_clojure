(ns classroom_booking.controller.controller
  (:require
    [clostache.parser :as clostache]
    [clojure.java.io]
    [classroom_booking.model.classroom :as classroom]
    [classroom_booking.model.classroom_type :as classroom_type]
    [classroom_booking.model.user_app :as user_app]
    [classroom_booking.model.reservation :as reservation]
    [classroom_booking.model.reservation_type :as reservation_type]
    [classroom_booking.model.reservation_status :as reservation_status]
    [classroom_booking.analytics.analytics :as analytics]
    ))
